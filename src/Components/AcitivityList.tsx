...
type AcitivityListProps = {
    activities: Activity[],
    dispatch: Dispatch<ActivityActions>

}

const AcitivityList = ({activities, dispatch} : AcitivityListProps) => {
    ...
    <div>   
        ...
        { isEmptyActivities ? 
            <p className="text-3xl font-bold text-orange-600 text-center mt-28">No hay actividades aun...</p> :
